    ...
    <section className="relative bg-white py-24 md:py-48 px-6 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto space-y-32 md:space-y-64">
        ...
        <div className="relative flex flex-col items-center">
          ...
          <div className="w-full md:w-auto md:absolute md:-bottom-20 md:right-32 bg-white md:p-12 z-20 space-y-4 md:shadow-2xl md:shadow-zinc-100 flex flex-col items-center md:items-end mt-8">
            <span className="font-sans text-[10px] uppercase tracking-[0.4em] text-zinc-400 font-medium">
              Section 03
            </span>
            <h3 className="font-serif text-4xl md:text-6xl text-zinc-900 tracking-tight">
