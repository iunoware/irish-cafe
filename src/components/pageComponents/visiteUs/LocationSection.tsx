    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-base text-neutral-600 font-sans leading-relaxed">
                                Located in the heart of KK Nagar, just a short walk from the
                                KK Nagar Arch and near the prominent Apollo Hospital area.
                            </p>
                        </div>
                    </div>
                ...
                <div
                    ref={mapRef}
                    className="lg:col-span-7 w-full h-[400px] md:h-[500px] lg:h-[600px] bg-neutral-100 rounded-sm overflow-hidden shadow-xl shadow-neutral-100 relative"
                >
                    <iframe
